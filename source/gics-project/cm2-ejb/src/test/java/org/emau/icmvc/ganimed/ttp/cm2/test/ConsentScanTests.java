...
public class ConsentScanTests
{
	...
	private static final List<String> idTypes = Arrays.asList(MPI_ID_TYPE);

	@BeforeAll
	public static void storeBasicEntries() throws VersionConverterClassException, MalformedURLException
	{
		logger.info("setup");
		...
		assertNotNull(service, "webservice object for CM2Manager is null");

		cm2Manager = service.getPort(GICSService.class);
		assertNotNull(cm2Manager, "cm2 manager object is null");
	...
	public void testScanOkService() throws UnknownDomainException, UnknownModuleException, UnknownConsentTemplateException,
			...
			DuplicateEntryException, InternalException, InconsistentStatusException, UnknownConsentException, RequirementsNotFullfilledException, InvalidParameterException
	{
		...
		ConsentDTO tmpConsent = cm2Manager.getConsent(consent.getKey());
	...
	@Test
	public void testScanBase64ErroneousService() throws UnknownDomainException, UnknownModuleException, UnknownConsentTemplateException,
			VersionConverterClassException, InvalidVersionException, MissingRequiredObjectException,
			InvalidFreeTextException, MandatoryFieldsException, UnknownSignerIdTypeException,
			DuplicateEntryException, InternalException, RequirementsNotFullfilledException
	{
	...
	public void testScanConstructorErroneous()
	{
		...
		{
			new ConsentScan(null, base64, "", null);
		});
	}
	...
	public void testScanFileTypeOk() throws UnknownModuleException, UnknownDomainException, InvalidParameterException, UnknownSignerIdTypeException, InvalidFreeTextException, DuplicateEntryException,
			...
			InternalException, InconsistentStatusException, UnknownConsentException
	{
		...
		ConsentDTO returnedConsent = cm2Manager.getConsent(consentKey);
			...
			InternalException, InconsistentStatusException, UnknownConsentException
	{
		...
		cm2Manager.removeScanFromConsent(consentKey, scan.getFhirID());

		logger.info("request consent");
		returnedConsent = cm2Manager.getConsent(consentKey);
