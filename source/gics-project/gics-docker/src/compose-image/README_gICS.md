...
---
**Hinweis:** Diese README beschäftigt sich nur mit dem Ausführen des gICS`s, Mittels vorhandenem gICS-Image (${docker.image.name}). Zum Einsatz kommt nur Docker-Compose.
