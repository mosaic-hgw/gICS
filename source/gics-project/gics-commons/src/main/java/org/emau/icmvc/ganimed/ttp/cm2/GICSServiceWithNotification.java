 ...
 * <a href="https://git.icm.med.uni-greifswald.de/ths/ths-notification">THS Notification Service</a>.
 *
 * @author moser
 */
@WebService
public interface GICSServiceWithNotification
{
	 ...
	 *
	 * @param notificationClientID the notification client ID (null or empty to skip sending a notification)
	 * @param consentKeyDTO the consent to update the QC for
	 * @param qc the new QC
	 ...
	 * @throws InvalidParameterException
	 * @see GICSService#setQCForConsent(ConsentKeyDTO, QCDTO)
	 */
	void setQCForConsent(
	 ...
	 *
	 * @param notificationClientID the notification client ID (null or empty to skip sending a notification)
	 * @param consentDTO the consent to add
	 * @throws UnknownDomainException
	 * @throws UnknownModuleException
	 * @throws UnknownConsentTemplateException
	 * @throws InvalidVersionException
	 * @throws MissingRequiredObjectException when there's no given value for a mandatory free text field
	 * @throws InvalidFreeTextException
	 * @throws MandatoryFieldsException see {@link MandatoryFieldsException}
	 * @throws UnknownSignerIdTypeException
	 * @throws DuplicateEntryException
	 * @throws RequirementsNotFullfilledException
	 * @throws InvalidParameterException
	 * @see GICSService#addConsent(ConsentDTO)
	 */
	void addConsent(
			@XmlElement(required = false) @WebParam(name = "notificationClientID") String notificationClientID,
			@XmlElement(required = true) @WebParam(name = "consent") ConsentDTO consentDTO)
			throws UnknownDomainException, UnknownModuleException, UnknownConsentTemplateException, InvalidVersionException,
			MissingRequiredObjectException, InvalidFreeTextException, MandatoryFieldsException, UnknownSignerIdTypeException,
			DuplicateEntryException, RequirementsNotFullfilledException, InvalidParameterException;
	 ...
	 *
	 * @param notificationClientID the notification client ID (null or empty to skip sending a notification)
	 * @param ctKeyDTO the consent template key
	 * @param signerIdDTOs the signer ID
	 * @throws InvalidVersionException
	 * @throws UnknownSignerIdTypeException
	 * @throws UnknownConsentTemplateException
	 * @throws UnknownDomainException
	 ...
	 * @throws InvalidParameterException
	 * @see GICSService#refuseConsent(ConsentTemplateKeyDTO, Set)
	 */
	void refuseConsent(
			@XmlElement(required = false) @WebParam(name = "notificationClientID") String notificationClientID,
	...
	void addConsentOptOut(String notificationClientID, ConsentTemplateKeyDTO templateKeyDTO, Set<SignerIdDTO> signerIdDTOs)
	 ...
	 *
	 * @param notificationClientID the notification client ID (null or empty to skip sending a notification)
	 * @param consentKeyDTO the consent key
	 * @param externProperties extern properties
	 ...
	 * @throws UnknownConsentException
	 * @throws InvalidParameterException
	 * @see GICSService#updateConsentInUse(ConsentKeyDTO, String, String, ConsentScanDTO)
	 */
	void updateConsentInUse(
			@XmlElement(required = false) @WebParam(name = "notificationClientID") String notificationClientID,
			@XmlElement(required = true) @WebParam(name = "consentKey") ConsentKeyDTO consentKeyDTO,
