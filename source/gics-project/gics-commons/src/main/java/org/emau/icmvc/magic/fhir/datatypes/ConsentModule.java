...
public class ConsentModule extends Type implements ICompositeType
{
	...
	@Override public boolean equals(Object o)
	{
		...
		if (!(o instanceof ConsentModule that))
			return false;

		return new EqualsBuilder()
				.append(getDomainName(), that.getDomainName())
				.append(_name, that._name)
				.append(_label, that._label)
				.append(_version, that._version)
				.append(_title, that._title)
				.append(_shortText, that._shortText)
				.append(_text, that._text)
				.append(_comment, that._comment)
				//.append(policyKeys, that.policyKeys)
				.append(getAssignedPolicies(), that.getAssignedPolicies())
