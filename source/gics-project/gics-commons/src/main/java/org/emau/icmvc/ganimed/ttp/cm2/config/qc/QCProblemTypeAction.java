...
@XmlType(name = "QCProblemTypeAction", propOrder = {
		"id",
		"labels"
})
...
{
	@Serial
	private static final long serialVersionUID = 881641611906216898L;
	 ...
	 *
	 * @param action
	 * 		the qc problem type action to copy
	 */
	public QCProblemTypeAction(QCProblemTypeAction action)
	{
		this(action != null ? action.getId() : null, action != null ? action.getLabels() : null);
	}
