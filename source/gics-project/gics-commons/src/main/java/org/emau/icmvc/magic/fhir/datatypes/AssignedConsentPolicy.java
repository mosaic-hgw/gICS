...
public class AssignedConsentPolicy extends Type implements ICompositeType
{
	...
	public String getComment()
	{
		...
		return StringUtils.isBlank(comment.getValue()) ? "" : comment.getValue();
	}
	...
	public String getExternProperties()
	{
		...
		return StringUtils.isBlank(externProperties.getValue()) ? "" : externProperties.getValue();
	}
	...
	public String getExpirationProperties()
	{
		...
		return StringUtils.isBlank(expirationProperties.getValue()) ? "" : expirationProperties.getValue();
	}
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof AssignedConsentPolicy that))
			return false;

		return new EqualsBuilder()
				.append(policyKey, that.policyKey)
	...
	@Override public String toString()
	{
		return new ToStringBuilder(this, FlexibleToStringStyle.THS_TO_STRING_STYLE)
				.append("policyKey", policyKey)
				.append("comment", getComment())
				.append("externProperties", getExternProperties())
				.append("expirationProperties", getExpirationProperties())
				.toString();
	}
