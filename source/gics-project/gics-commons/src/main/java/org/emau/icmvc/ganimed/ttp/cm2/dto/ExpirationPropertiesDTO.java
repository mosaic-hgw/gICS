...
public class ExpirationPropertiesDTO implements Serializable
{
	...
	public boolean equals(Object obj)
	{
		...
		else if (!DateUtils.truncate(fixedExpirationDate, Calendar.DATE).equals(DateUtils.truncate(other.fixedExpirationDate, Calendar.DATE)))
		{
			return false;
		}
		if (validPeriod == null)
		{
			return other.validPeriod == null;
		}
		else
			return validPeriod.equals(other.validPeriod);
	}
