...
{
	@Serial
	private static final long serialVersionUID = 769207858848092779L;

	private final ItemType illegalItemType;
	private final String illegalItem;

	public IllegalCompositionException()
	{
		this(null, null, null);
	}

	public IllegalCompositionException(String message, String illegalItem, ItemType illegalItemType)
	{
		super(message);
		this.illegalItemType = illegalItemType;
