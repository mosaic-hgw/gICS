...
public class Dates
{
	...
	/**
	 * {@return the specified date at the start of its day (w.r.t. the system's default zone)}
	...
	/**
	 * {@return the specified local date at the start of its day (w.r.t. the system's default zone)}
	...
	/**
	 * {@return the specified local date as a date (w.r.t. the system's default zone)}
	...
	/**
	 * {@return the specified date as a local date (w.r.t. the system's default zone)}
	...
	/**
	 * {@return true if the specified date refers to a day in the future (w.r.t. the system's default zone) or is null (for infinite future)}
	 * @param date the date to check
	 */
	public static boolean isFutureDay(Date date)
	{
		return date == null || isFutureDay(toLocalDate(date));
	}

	/**
	 * {@return true if the specified local date refers to a day in the future (w.r.t. the system's default zone) or is null (for infinite future)}
	 * @param localDate the local date to check
	 */
	public static boolean isFutureDay(LocalDate localDate)
	{
		return localDate == null || today().isBefore(atStartOfDay(localDate));
	}
}
