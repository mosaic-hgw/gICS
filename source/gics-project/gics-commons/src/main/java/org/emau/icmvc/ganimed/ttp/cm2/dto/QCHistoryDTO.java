...
public class QCHistoryDTO extends QCDTO
{
	...
	/**
	 * Note that you can not pass a list of problems as parameter. This reflects, that the JPA class QCHist does not have problems.
	 */
	...
	{
		super(qcPassed, type, date, inspector, comment, externProperties, null, fhirID);
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof QCHistoryDTO that))
			return false;
