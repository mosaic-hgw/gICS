...
{
	public static final Map<ConsentTemplateType, String> templateTypeKeys = new LinkedHashMap<>();

	static
	{
		templateTypeKeys.put(ConsentTemplateType.CONSENT, "informed_consents");
		templateTypeKeys.put(ConsentTemplateType.CONSENT_OPT_OUT, "informed_consents_opt_out");
		templateTypeKeys.put(ConsentTemplateType.REVOCATION, "withdrawals");
		templateTypeKeys.put(ConsentTemplateType.OBJECTION, "objections");
		templateTypeKeys.put(ConsentTemplateType.REFUSAL, "refusals");
	}
	...
	public static final String CONSENTS = templateTypeKeys.get(ConsentTemplateType.CONSENT);
	public static final String REVOCATIONS = templateTypeKeys.get(ConsentTemplateType.REVOCATION);
	public static final String REFUSALS = templateTypeKeys.get(ConsentTemplateType.REFUSAL);
	public static final String OBJECTIONS = templateTypeKeys.get(ConsentTemplateType.OBJECTION);
	public static final String CONSENTS_OPT_OUT = templateTypeKeys.get(ConsentTemplateType.CONSENT_OPT_OUT);
