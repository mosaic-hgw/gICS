...
public class InvalidParameterException extends Exception
{
	...
	public InvalidParameterException(String paramName, String message, Throwable cause)
	{
		super(firstNonBlankMessage(message, cause), cause);
	...
	private static String firstNonBlankMessage(String msg, Throwable t)
	{
		if (StringUtils.isBlank(msg) && t != null)
		{
			return firstNonBlankMessage(t.getMessage(), t.getCause());
		}
		return msg;
	}
}
