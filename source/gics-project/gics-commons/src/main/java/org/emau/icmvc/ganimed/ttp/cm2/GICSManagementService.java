...
public interface GICSManagementService
{
	...
	void updateDomain(
			@XmlElement(required = true) @WebParam(name = "domain") DomainDTO domainDTO)
			throws InvalidParameterException, ObjectInUseException, UnknownDomainException, VersionConverterClassException;
	...
	void updateDomainInUse(
			...
			@XmlElement(required = true) @WebParam(name = "expirationProperties") ExpirationPropertiesDTO expirationProperties,
			@XmlElement(required = true) @WebParam(name = "comment") String comment,
			@XmlElement(required = false) @WebParam(name = "config") DomainConfig config)
			throws InvalidParameterException, UnknownDomainException, VersionConverterClassException;
	 ...
	 *             is not a valid string for {@link java.text.SimpleDateFormat}
	...
	void addConsentTemplate(
			...
			FreeTextConverterStringException, InvalidPropertiesException, RequirementsNotFullfilledException, UnknownConsentTemplateException, IllegalCompositionException;
	...
	void processPolicyValidityChanges(List<DomainDTO> domains)
	...
	/*
	+listQCProblemTypes(String domainName) : List~QCProblemType~
	+listQCProblemTypeActions(String domainName) : List~QCProblemTypeAction~
	+listQCTypes(String domainName) : List~QCType~
	+addQCProblemType(String domainName, QCProblemType) : void
	+addQCProblemTypeAction(String domainName, QCProblemTypeAction) : void
	+addQCType(String domainName, QCType) : void
	 */
}
