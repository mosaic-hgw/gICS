...
public class ConsentLightDTO extends FhirIdDTO implements Serializable, DomainRelated
{
	...
	public ConsentLightDTO(ConsentLightDTO lightDTO)
	{
		...
		setValidFromProperties(lightDTO.getValidFromProperties());
	...
	public boolean equals(Object obj)
	{
		...
		if (validFromDate == null)
		{
			return other.validFromDate == null;
		}
		else
			return validFromDate.equals(other.validFromDate);
	}
	...
	public String toString()
	{
		return key
			   ...
			   + moduleStates.size()
			   + " module states, qc is "
			   + (qualityControl != null ? qualityControl.isQcPassed() ? "" : "not" : "null")
			   + " passed, "
			   + consentDates
			   + ", validFromDate "
			   + validFromDate
