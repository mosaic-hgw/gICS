...
public class AssignedModuleDTO extends FhirIdDTO implements Serializable, DomainRelated
{
	...
	public List<ConsentStatus> getDisplayCheckboxesOrderedForTemplateType(ConsentTemplateType type)
	{
		return ConsentStatus.getOrderedStatusesForConsentTemplateType(type, getDisplayCheckboxes());
	}
