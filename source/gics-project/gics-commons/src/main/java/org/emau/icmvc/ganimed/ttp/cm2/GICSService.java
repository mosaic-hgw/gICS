...
public interface GICSService
{
	 ...
	 * It is equal to 'addConsent' with a fully filled opt-out-consent with default-module-states and current consentDate.
	 *
	 * @param ctKeyDTO
	 * @param signerIdDTOs
	 * @return
	 ...
	 * @throws DuplicateEntryException
	 */
	ConsentLightDTO addConsentOptOut(@XmlElement(required = true) @WebParam(name = "consentTemplateKey") ConsentTemplateKeyDTO ctKeyDTO, @XmlElement(required = true) @WebParam(name = "signerIds") Set<SignerIdDTO> signerIdDTOs)
	...
	/**
	 * {@return the number of all signed policies for a given domain.}
	 *
	 * @param domainName
	 ...
	 * @throws InvalidVersionException
	 */
	ConsentTemplateDTO getConsentTemplate(@XmlElement(required = true) @WebParam(name = "consentTemplateKey") ConsentTemplateKeyDTO ctKeyDTO)
	 ...
	 * <li>when there's at least one accepted module and scan is mandatory in domain config and parameter validateScan is true, scan must be present
	 *
	 * @param consentDTO
	 * @param allowRevoke
	 * @param validateScan
	...
	void validateConsent(@XmlElement(required = true) @WebParam(name = "consent") ConsentDTO consentDTO,
			...
			@XmlElement(required = true) @WebParam(name = "validateScan") boolean validateScan)
	...
	List<QCHistoryDTO> getQCHistoryForConsent(
			@XmlElement(required = true) @WebParam(name = "consentKey") ConsentKeyDTO consentKeyDTO)
			throws InvalidParameterException, InvalidVersionException, UnknownConsentException, UnknownSignerIdTypeException, UnknownConsentTemplateException, UnknownDomainException;

	@XmlElementWrapper(nillable = true, name = "return")
	@XmlElement(name = "qcProblemHistories")
	List<QCProblemHistoryDTO> getQCProblemHistoryForQCProblem(
			@XmlElement(required = true) @WebParam(name = "qcProblem") QCProblemDTO qcProblemDTO,
			@XmlElement(required = true) @WebParam(name = "consentKey") ConsentKeyDTO consentKeyDTO)
			throws InvalidParameterException, InvalidVersionException, UnknownConsentException, UnknownSignerIdTypeException, UnknownConsentTemplateException, UnknownDomainException;
	 ...
	 *
	 * @param policyKeyDTOs
	 * 		the keys of the policies to find related consent templates for
	 * @return consent templates relating to the specified policies
	 * @throws UnknownDomainException
	 * 		if the related domain is unknown
	 * @throws InvalidVersionException
	 * 		if any of the consent templates version is invalid
	 * @throws InvalidParameterException
	 ...
	 *
	 * @param domainName
	 * 		the name of the domain to return consent templates for
	 * @param ctType
	 * 		the type of consent templates to return
	 * @param signerId
	 * 		the signer ID to return consent templates for
	 * @param useAliases
	 * 		true to use aliases
	...
	List<PolicyValidityChangedDTO> getPolicyValidityStatusChangesForConsent(ConsentLightDTO consentDTO, Date fromDate, Date toDate)
