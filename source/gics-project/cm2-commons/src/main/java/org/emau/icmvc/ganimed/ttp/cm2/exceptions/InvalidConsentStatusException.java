 ...
 *
 */
public class InvalidConsentStatusException extends Exception
{
	private static final long serialVersionUID = -92853437174431980L;

	public InvalidConsentStatusException()
	{
		super();
	}
