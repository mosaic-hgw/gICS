...
public class ExpirationPropertiesDTO implements Serializable
{
	...
	public ExpirationPropertiesDTO(ExpirationPropertiesDTO dto)
	{
		...
		if(dto.getFixedExpirationDate()!=null){
			fixedExpirationDate = new Date(dto.getFixedExpirationDate().getTime());
		}

		if(dto.getValidPeriod()!=null){
			validPeriod = Period.of(dto.getValidPeriod().getYears(), dto.getValidPeriod().getMonths(), dto.getValidPeriod().getDays());
		}
	}
