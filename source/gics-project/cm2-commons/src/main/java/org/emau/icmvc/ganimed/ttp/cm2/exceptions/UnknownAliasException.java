...
{
	private static final long serialVersionUID = -539312880994604493L;
	...
	public UnknownAliasException(String message, Throwable cause)
	{
		super(message, cause);
	}

	public UnknownAliasException(String message)
	{
		super(message);
	}
