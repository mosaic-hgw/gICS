...
/**
 * should be thrown when the given converter string (in case of {@link FreeTextType}.Date) is not a valid string for {@link SimpleDateFormat}
 *  
 * @author geidell
 *
 */
public class FreeTextConverterStringException extends Exception {
	...
	private static final long serialVersionUID = -6059330149573216443L;
