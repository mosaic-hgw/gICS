...
{
	private static final long serialVersionUID = 7445757172109500534L;
	private String name;
	...
	{
		this(dto.getName(), dto.getCreateTimestamp(), dto.getUpdateTimestamp(), dto.getLabel(), dto.getComment(), dto.getFhirID());
	}
	...
	public void setUpdateTimestamp(Date updateTimestamp)
	{
		...
		{
			this.updateTimestamp = new Date(updateTimestamp.getTime());
		}
		else
		{
