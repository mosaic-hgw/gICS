package org.emau.icmvc.ganimed.ttp.cm2.frontend.testtools;
...
public abstract class GicsWebTest extends JsfTest
{
	...
	@Mock(answer = Answers.RETURNS_DEEP_STUBS)
	protected GICSManagementService managementService;

	@BeforeEach
	protected void setUpGicsWebTest()
	{}
}
