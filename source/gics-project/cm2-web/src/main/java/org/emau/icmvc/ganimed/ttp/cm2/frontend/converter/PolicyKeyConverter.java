...
{
	private PolicyKeyConverter()
	{}

	/**
	 * Convert PolicyKeyDTOs in list of PolicyDTOs to list of keystrings
	 *
	 * @param list
	 ...
	 */
	public static List<String> getKeysAsStrings(List<PolicyDTO> list, char sep)
	{
