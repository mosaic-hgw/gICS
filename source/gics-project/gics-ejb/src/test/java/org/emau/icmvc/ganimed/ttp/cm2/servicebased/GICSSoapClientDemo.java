...
public class GICSSoapClientDemo extends AbstractServiceBasedTest
{
	...
	private void addConsentsForNextPersons(int number, QCTypeValue qcTypeValue, boolean withSignatures, boolean withScan)
	{
		try
		{
			...
			{
				ConsentDTO consent = cloneConsentForPerson(start + i, qcTypeValue, withSignatures, withScan);
	...
	public ConsentDTO cloneConsentForPerson(int personNumber, QCTypeValue qcTypeValue, boolean withSignatures, boolean withScan)
	{
		...
		if (qcTypeValue != null && !qcTypeValue.equals(QCTypeValue.initial))
		{
			consent.setQualityControl(new QCDTO(true, qcTypeValue.name(), new Date(), "ich", "", "", null, null));
		}
	...
	public static void main(String[] args)
	{
		try
		{
			...
			QCTypeValue qcTypeValue = QCTypeValue.valueOf(argOrElse(args, 4, QCTypeValue.initial.name()));
			...
			demo.addConsentsForNextPersons(number, qcTypeValue, withSignature, withScan);
		}
		catch (Throwable t)
		{
