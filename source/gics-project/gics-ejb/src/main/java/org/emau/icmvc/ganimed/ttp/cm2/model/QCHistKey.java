...
public class QCHistKey implements Serializable
{
	...
	public QCHistKey(QCKey qcKey, Date startDate)
	{
		super();
		this.qcKey = qcKey;
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof QCHistKey qcHistKey))
			return false;

		return new EqualsBuilder()
				.append(getQcKey(), qcHistKey.getQcKey())
				.append(getStartDate(), qcHistKey.getStartDate())
				.isEquals();
	}
