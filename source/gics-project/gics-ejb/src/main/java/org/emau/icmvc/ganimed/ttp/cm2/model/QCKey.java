...
@Embeddable
public class QCKey implements Serializable
{
	@Serial
	...
	public QCKey(ConsentKey consentKey)
	{
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof QCKey that))
			return false;

		return new EqualsBuilder()
				.append(getConsentKey(), that.getConsentKey())
				.isEquals();
	}
