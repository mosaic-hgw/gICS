...
public abstract class GICSServiceBase extends AbstractGicsServiceBase
{
	...
	protected void checkParameter(Object parameter, String paramName) throws InvalidParameterException
	{
		...
		else if (parameter instanceof DomainDTO temp)
		{
			...
			checkParameter(temp.getConfig(), paramName + ".config");
		}
		else if (parameter instanceof DomainConfig temp)
		{
			temp.validate(paramName);
		}
