...
{
	private static final long serialVersionUID = -8864969601673936306L;
	...
	public ModulePolicy(Module module, Policy policy, AssignedPolicyDTO assignedPolicyDTO)
	{
		...
		this.expirationPropertiesObject = new ExpressionExpirationPropertiesObject(assignedPolicyDTO.getExpirationProperties());
	...
	public void updateInUse(String comment, String externProperties, ExpressionExpirationPropertiesDTO expirationProperties)
	{
	...
	{
		updateInUse(assignedPolicyDTO.getComment(), assignedPolicyDTO.getExternProperties(), assignedPolicyDTO.getExpirationProperties());
	}

	private void updateExpiration(ExpressionExpirationPropertiesDTO expiration)
	{
		// for finalized modules only allow to update future expiration properties (existing as well as new date must be in the future)
		this.expirationPropertiesObject = expirationPropertiesObject.createMergedExpirationProperties(expiration, module.getFinalised());
		this.expirationProperties = expirationPropertiesObject.toPropertiesString();
	}
