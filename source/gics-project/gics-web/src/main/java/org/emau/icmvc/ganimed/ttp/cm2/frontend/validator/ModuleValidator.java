 ...
 */
@RequestScoped
@Named("modulesValidator")
public class ModuleValidator implements Validator<DualListModel<AssignedModuleDTO>>, Serializable
{
	@Serial
	private static final long serialVersionUID = -1778978182806776059L;

	@Override
	public void validate(FacesContext arg0, UIComponent arg1, DualListModel<AssignedModuleDTO> arg2) throws ValidatorException
	{
		ArrayList<AssignedModuleDTO> modules = new ArrayList<>(arg2.getTarget());
