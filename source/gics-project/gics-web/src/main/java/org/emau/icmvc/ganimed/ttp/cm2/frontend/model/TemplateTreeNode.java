...
public class TemplateTreeNode
{
	...
	public String getExpiration()
	{
		...
		if (expiration != null)
		{
			...
			if (expiration instanceof ExpressionExpirationPropertiesDTO expressionExpirationPropertiesDTO
					&& expressionExpirationPropertiesDTO.getExpirationExpression() != null)
			{
				...
				result.append(expressionExpirationPropertiesDTO.getExpirationExpression());
			}
		}
