 ...
 */
@RequestScoped
@Named("policiesValidator")
public class PoliciesValidator implements Validator<DualListModel<PolicyDTO>>, Serializable
{
	@Serial
	private static final long serialVersionUID = -8621915189479508845L;

	@Override
	public void validate(FacesContext arg0, UIComponent arg1, DualListModel<PolicyDTO> arg2) throws ValidatorException
	{
		ArrayList<PolicyDTO> policies = new ArrayList<>(arg2.getTarget());
