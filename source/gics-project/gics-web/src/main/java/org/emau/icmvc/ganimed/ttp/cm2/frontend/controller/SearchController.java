...
public class SearchController extends AbstractConsentController
{
	@Serial
	...
	{
		Set<SignerIdDTO> signerIdSet = Set.of(new SignerIdDTO(sidKey, sidValue, null, null));

		for (ConsentLightDTO consent : getService().getAllConsentsForSignerIds(domainSelector.getSelectedDomainName(), signerIdSet, false))
		{
