...
@RequestScoped
@Named("mediaProvider")
public class MediaProviderBean implements Serializable
{
	@Serial
	private static final long serialVersionUID = -8019971003364568010L;
	...
	static
	{
		...
		try
		{
			...
			try (InputStream is = Thread.currentThread().getContextClassLoader().getResourceAsStream(NO_SCAN_FILE))
			{
